...
public class RouteFinishAdapter extends BaseExpandableListAdapter {

    private Context mContext;
    private List<Daily> mParents;
    private Map<Integer, List<Sight>> mSights;

    public RouteFinishAdapter(Context context, List<Daily> parents, Map<Integer, List<Sight>> sights) {
        mContext = context;
        mParents = parents;
        mSights = sights;
    }
