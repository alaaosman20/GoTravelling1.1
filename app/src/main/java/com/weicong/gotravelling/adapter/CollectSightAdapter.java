...
public class CollectSightAdapter extends RecyclerView.Adapter<CollectSightAdapter.MyViewHolder> {

    private List<SearchSight> mItems;

    private Context mContext;

    public CollectSightAdapter(Context context, List<SearchSight> list) {
        mContext = context;
        mItems = list;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final SearchSight sight = mItems.get(position);
