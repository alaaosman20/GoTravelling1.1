...
public class RouteCollectionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_route_collection, container, false);
    ...
    private void showDeleteRouteDialog(final int position) {
        String message = "您确定要取消收藏" + mRoutes.get(position).getName() + "路线吗？";
    ...
    private void deleteRoute(final int position) {
        ...
        UserManager.getInstance(getActivity()).notCollectRoute(route, new UserManager.OnUpdateListener() {
            @Override
