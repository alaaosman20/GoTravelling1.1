...
public class RouteFinishedActivity extends SwipeBackBaseActivity {
    ...
    private void initViews() {
        ...
        TextView followNum = (TextView) header.findViewById(R.id.tv_follow_num);
        int follow = 0;
        if (mRoute.getFollowNum() != null) {
            follow = mRoute.getFollowNum();
        }
        followNum.setText(String.valueOf(follow));
        ...
        TextView favorNum = (TextView) header.findViewById(R.id.tv_favor_num);
        int favor = 0;
        ...
        noteView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RouteFinishedActivity.this, FinishNoteActivity.class);
        ...
        commentView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RouteFinishedActivity.this, CommentActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_route_finish, menu);
