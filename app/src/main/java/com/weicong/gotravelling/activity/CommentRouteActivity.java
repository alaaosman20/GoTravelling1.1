...
public class CommentRouteActivity extends SwipeBackBaseActivity {
    ...
    private void getData() {
        ...
        query.addWhereRelatedTo("commentRoutes", new BmobPointer(user));
        ...
        query.findObjects(this, new FindListener<Route>() {
            ...
            public void onSuccess(List<Route> list) {
                mItems = list;
                mAdapter = new CollectRouteAdapter(CommentRouteActivity.this, mItems);
